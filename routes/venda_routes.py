...
def buscar_vendas(id_vendedor: int = None, id_cliente: int = None, data_realizada: str = None):
    vendas = venda_service.buscar_produto(id_vendedor, id_cliente, data_realizada)
    return venda